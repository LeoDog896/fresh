...
export { walk } from "https://deno.land/std@0.158.0/fs/walk.ts";
...
export { Status } from "https://deno.land/std@0.158.0/http/http_status.ts";
export {
  typeByExtension,
} from "https://deno.land/std@0.158.0/media_types/mod.ts";
